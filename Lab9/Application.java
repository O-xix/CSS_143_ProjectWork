...
public class Application extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		JOptionPane jOptionPane = new JOptionPane(e);
		//Not how you use it, but I can see it trying. It gives me a bunch of exceptions.
		JOptionPane.showMessageDialog(jOptionPane, e, getTitle(), ABORT);;
	}
}
