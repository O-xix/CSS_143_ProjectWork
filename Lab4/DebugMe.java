...
public class DebugMe {
	 ...
	 * @param args
	 */
	public static void printSums(String a) {
	...
	//Liar. It's not.
	//The following is actually what your output should look like when your
	//Box class is correct.
	...
	public static void compareBoxes(){
		...
		Box[] array = new Box[5];
		array[0] = new Box(4,5,3,2); //120
		array[1] = new Box(2,3,3,1); //18
		array[2] = new Box(3,10,2,2); //120
		array[3] = new Box(4,4,4,1); //64
		array[4] = new Box(5,7,1,1); //35
